  ...
  render() {
    ...
    return (
      <Modal
        ...
        className="dialog number-input-dialog" 
        ...
        <div className="dialog-container" ref="container">
          ...
          <div className='number-cancel' data-key='cancel' {...tapOrClick(self.onKeyPressed.bind(self))}>取消</div>
          <div className='number-confirm' data-key='confirm' {...tapOrClick(self.onKeyPressed.bind(self))}>确定</div>
        </div>
      </Modal>
    );
  }
