  ...
  render(){
    return (
      <div>
        ...
        <span className={'holdTime ' + (this.state.type!='hold for time'?'translucent':'')}>time</span>
        ...
        <span className={'amplitude ' + (this.state.type!='change slowly'?'translucent':'')}>Max Change</span>
