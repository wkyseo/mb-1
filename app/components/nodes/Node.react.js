...
class Outputs extends Component {
  ...
  renderOutputs(){
    let ports = this.props.ports.map((value, i) => {
      return (
        <div className='node-port-output node-port' key={i} id={this.props.nodeId+'-'+value} data-type='output'>
          <div className={'core ' +(this.props.showValue==true?'show':'')}>
  ...
  render() {
    return (
      <div className="node-tools">
        ...
        <div className={'tab-mask node-draggable ' + ((this.state.isDisconnected && this.props.isElectronic) ?'':'hide')}>
