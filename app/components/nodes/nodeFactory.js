...
import { CloudReadNode } from './data/cloudRead/CloudRead.react';
import { CloudSendNode } from './data/cloudSend/CloudSend.react';
...
let factory = {
  ...
  'IMAGE':ImageNode,
  'PATTERN':PatternNode,
  'CLOUDREAD': CloudReadNode,
  'CLOUDSEND': CloudSendNode,
  'PULSE': Pulse,
  'RANDOM': Random,
  'SCALE': ScaleNode,
  'FILTER': FilterNode,
